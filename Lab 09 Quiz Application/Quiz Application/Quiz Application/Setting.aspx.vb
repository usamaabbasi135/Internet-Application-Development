...
Public Class Setting
    ...
    Private Sub insertSetting(numberOfQuestions As Integer, isQuestionShuffle As Boolean, isAnswerShuffle As Integer,
        ...
        insertSQL = "INSERT INTO QuizSetting_Table(NoOfQuestions, isShuffle, isAnswerShuffle,"
        insertSQL &= " timeLimit, SetOfQuestionsAtOnce, isNegativeMarking, startTime)"
        insertSQL &= "VALUES ("
        insertSQL &= "@numberOfQuestions, @isQuestionShuffle, @isAnswerShuffle,"
        insertSQL &= "@durationOfQuiz, @SetOfQuestionsAtOnce, @isNegativeMarking,"
        ...
        cmd.Parameters.AddWithValue("@SetOfQuestionsAtOnce", noOfQuestionsToBeShown)
        ...
        Catch err As Exception
            lbl_showErrorMessages.Text = "<b>The Quiz Setting cannot be inserting at the time!</b> " & err.Message
    ...
    Private Sub updateSetting(numberOfQuestions As Integer, isQuestionShuffle As Boolean, isAnswerShuffle As Integer,
        ...
        updateSQL = "UPDATE QuizSetting_Table Set NoOfQuestions = @numberOfQuestions, isShuffled = @isQuestionShuffle,"
    ...
    Private Sub showSetting()
        ...
        SQLStatement = "SELECT * From QuizSetting_Table"
        ...
        radiobtn_isQuestionShuffleTrue.Checked = dsQuizDB.Tables("QuizSetting").Rows.Item(0).Field(Of Boolean)("isShuffle")
        radiobtn_isAnswerShuffleTrue.Checked = dsQuizDB.Tables("QuizSetting").Rows.Item(0).Field(Of Boolean)("isAnswerShuffle")
        ...
        txtbox_NoOfQuestionToBeShown.Text = dsQuizDB.Tables("QuizSetting").Rows.Item(0).Field(Of Integer)("SetOfQuestionsAtOnce")
    ...
    Private Function IsSettingExisting() As Boolean
        ...
        SQLStatement = "SELECT Count(*) As records From QuizSetting_Table"
